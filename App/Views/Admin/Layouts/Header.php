...
class Header extends BaseView
{
  public static function render($data = null)
  {
    ...
    <html lang="en" class="light-style layout-menu-fixed layout-compact" dir="ltr" data-theme="theme-default"
      data-assets-path="<?= APP_URL ?>/public/assets/admin/assets/" data-template="vertical-menu-template-free"
      data-style="light">
    ...
    <head>
      ...
      <!-- Core CSS -->
      <link rel="stylesheet" href="<?= APP_URL ?>/public/assets/admin/assets/vendor/css/core.css"
        class="template-customizer-core-css" />
      <link rel="stylesheet" href="<?= APP_URL ?>/public/assets/admin/assets/vendor/css/theme-default.css"
        class="template-customizer-theme-css" />
      <link rel="stylesheet" href="<?= APP_URL ?>/public/assets/admin/assets/css/demo.css" />

      <!-- Vendors CSS -->
      <link rel="stylesheet"
        href="<?= APP_URL ?>/public/assets/admin/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css" />
