...
?>
    ...
    <ul class="menu_account">
      <li>
        <a href="/users/<?= $_SESSION['user']['id'] ?>"><svg class="mx-2" xmlns="http://www.w3.org/2000/svg" width="20"
            height="20" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);transform: ;msFilter:;">
            <path
